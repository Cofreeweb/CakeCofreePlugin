 ...
 */
class CofreeEventManager extends CakeEventManager {
...
/**
 * Returns the globally available instance of a CofreeEventManager
 * @return CofreeEventManager the global event manager
 */
	public static function instance($manager = null) {
		if (empty(self::$_generalManager)) {
			return parent::instance(new CofreeEventManager());
		}
 ...
 */
	public static function loadListeners() {
		$eventManager = CofreeEventManager::instance();
