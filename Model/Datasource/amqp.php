 ...
 * @return bool
 */
	public function publish($message, $routingKey, $flags = AMQP_NOPARAM, $queueName = false, $attributes = array()) {
		$this->connect();
      ...
      $queue->declare();
      $queue->bind( $this->config['exchange'], $routingKey);
		}
	...
	public function consumeQueue( $routingKey, $queueName = false, $flags = AMQP_NOPARAM) {
		$this->connect();
